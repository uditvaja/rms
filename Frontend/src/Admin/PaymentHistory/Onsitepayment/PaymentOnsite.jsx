...
const PaymentOnsite = () => {
  ...
  useEffect(() => {
    // Fetch onsite payment history from the API
    const fetchData = async () => {
      try {
        const response = await fetchOnsitePaymentHistory(); // Call the API
    ...
    <>
      ...
      >
        <div className="flex justify-between mb-6">
          <h1 className="text-2xl font-semibold ">Onsite Order</h1>
        </div>
        ...
        <div className="fixed inset-0 bg-gray-900 bg-opacity-75 flex justify-center items-center">
          <div className="bg-[#252836] text-white p-6 rounded-lg max-w-sm w-full shadow-lg">
            ...
            <div className="flex justify-between items-center border-b border-gray-700 pb-4">
              <h2 className="text-lg font-semibold">Onsite Payment Bill</h2>
              <button
                onClick={closeModal}
